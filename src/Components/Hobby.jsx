...
function Hobby() {
  ...
  return (
    <div  className=' relative w-full bg-[#F0F0F0] h-[50vh] sm:h-screen '>  
    <div className=' absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] w-full px-10 sm:px-20'>
            <h1 className=' font-bold text-2xl pb-10'>Hobby</h1>  
            {/* for mobile  */}
            <div className=' main sm:hidden flex flex-col gap-2'>
